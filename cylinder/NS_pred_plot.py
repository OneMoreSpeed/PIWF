...
if __name__ == "__main__":
    ...
    num_T = len(aim_T)
    print(aim_T)
    layers_hidden = [3, 128, 128, 128, 128, 3]
    ...
    for n in range(num_T):
        ...
        # 将NumPy数组保存到文件中
    np.save('res_u_mean_PIKAN.npy', res_u_mean_list)
    np.save('res_v_mean_PIKAN.npy', res_v_mean_list)
    np.save('res_p_mean_PIKAN.npy', res_p_mean_list)
