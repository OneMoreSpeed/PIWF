...
np.save(f'4layer_LBFGS_train_loss.npy', results['train_loss'])
np.save(f'4layer_LBFGS_pde_loss.npy', results['pde_loss'])
np.save(f'4layer_LBFGS_test_loss.npy', results['test_loss'])
