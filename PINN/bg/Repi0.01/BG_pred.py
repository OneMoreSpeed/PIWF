...
checkpoint = torch.load('./N[2, 50, 50, 50, 50, 50, 50, 1]_lr1.0e-03/weight200000.checkpoint',map_location=torch.device('cpu'))
...
# 将NumPy数组保存到文件中
np.save(f'u_predBG_PINN.npy', pred_u)
np.save(f'u_resBG_PINN.npy', res_u)
