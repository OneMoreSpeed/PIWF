...
if __name__ == "__main__":
    ...
    checkpoint = torch.load('./N4_lr1.0e-03/weight100000.checkpoint', map_location=device)
    ...
    for n in range(num_T):
        ...
        # 将NumPy数组保存到文件中
    np.save('res_u_mean_PIFAN.npy', res_u_mean_list)
    np.save('res_v_mean_PIFAN.npy', res_v_mean_list)
    np.save('res_p_mean_PIFAN.npy', res_p_mean_list)
