...
class MLPHead(nn.Module):
    ...
    def __init__(self,channel_size,hidden_size,out_size):
        ...
        nn.Linear(channel_size, out_size, bias=False),
        nn.GELU()
        )
...
class WAVEFANLayer(nn.Module):
    ...
    def __init__(self,input_dim, output_dim, p_ratio=0,q_ratio=0.3,j_max=3,k_range=(-2, 2), wavelet_type='haar', activation='tanh', use_p_bias=True):
