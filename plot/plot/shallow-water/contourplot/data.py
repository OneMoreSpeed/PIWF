...
#             print("Using CUDA random generator")
#         except Exception as e:
#             print(f"Failed to create CUDA generator: {e}")
#             print("Falling back to CPU generator")
#             generator = torch.Generator(device='cpu')
#             generator.manual_seed(42)
#     else:
#         generator = torch.Generator(device='cpu')
#         generator.manual_seed(42)
#         print("Using CPU random generator")
    
#     BATCH_SIZE = int(nx * nt / 3)
    
#     # 创建DataLoader时传入generator
#     dataloaders = {
...
#             generator=generator
#         ),
#         'initial': torch.utils.data.DataLoader(
#             initial_condition_dataset, 
#             batch_size=BATCH_SIZE, 
#             shuffle=True,
#             generator=generator
#         ),
#         'periodic': torch.utils.data.DataLoader(
#             boco_dataset, 
#             batch_size=BATCH_SIZE, 
#             shuffle=True,
#             generator=generator
