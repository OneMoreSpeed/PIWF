...
if __name__ == "__main__":  
    ...
    u_pred = np.load('./burgers_solution.npy')
    ...
    cb_label = r"$u$"#, r"$\mathdefault{\bar U_y}$", r"$\mathdefault{\bar U_z}$"]
    ...
    for suffix in g_suffix:
        figName = "contour_{}.{}".format(fieldName1, suffix)
